...
public enum Direction {
 ...
 public static Direction fromAxisAndDirection(EnumAxis var0, EnumAxisDirection var1) {
	...
	switch(var0.ordinal()) {
	 case 0:
		var10000 = var1 == Direction.EnumAxisDirection.POSITIVE ? EAST : WEST;
		break;
	 case 1:
		var10000 = var1 == Direction.EnumAxisDirection.POSITIVE ? UP : DOWN;
		break;
	 case 2:
		var10000 = var1 == Direction.EnumAxisDirection.POSITIVE ? SOUTH : NORTH;
		break;
	 default:
		var10000 = null;
	}
